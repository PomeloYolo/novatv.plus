...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://raw.githubusercontent.com/PomeloYolo/NovaTV/refs/heads/main/VERSION.txt',
...
function addVersionInfoToFooter() {
    checkForUpdates().then(result => {
        ...
        // 添加当前版本信息
        versionElement.innerHTML = `版本: ${result.currentFormatted} <a href="https://github.com/PomeloYolo/NovaTV/releases" target="_blank" class="text-blue-500 underline ml-1">更新說明</a>`;
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/PomeloYolo/NovaTV', '_blank');
                    });
                }
            }, 100);
        } else {
